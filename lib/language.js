 ...
    , { code: 'zh_tw', language: '中文（繁體）' }
  ...
  var translations = {
    ...
    ,'Excess insulin equivalent %1U more than needed to reach low target, MAKE SURE IOB IS COVERED BY CARBS' : {
      ...
      ,nl: 'Overschot insuline %1U meer dan nodig om het laag doel te bereiken, ZORG ERVOOR DAT IOB VERZEKERD IS MET KOOLHYDRATEN'
